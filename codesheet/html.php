...
<div class="all-elements">
    ...
    <div id="content" class="snap-content">        
        ...
        <div class="content">
            ...
            <div class="container">
                <div class="toggle-3">
                    <a href="#" class="deploy-toggle-3"><?php echo htmlspecialchars('<a>标签');?><em class=""><strong class=""></strong></em></a>
                    <div class="toggle-content" style="display: none;">               
                        <p>
                            <span class="text-highlight highlight-green">定义</span>
                            <?php echo htmlspecialchars('<a> 标签定义超链接，用于从一张页面链接到另一张页面。');?>      
                        </p>
                        <p>
                        ...
                        <p>
                            ...
                            <?php echo htmlspecialchars('<a href="http://www.baidu.com">百度</a> <!--指向 百度 的超链接-->');?>     
                        </p>
                        <p>
                            <span class="text-highlight highlight-orange">注释</span>
                            浏览器支持：IE Firefox Chrome Safari Opera <br />
                            <?php echo htmlspecialchars('<a> 元素最重要的属性是 href 属性，它指示链接的目标。');?> <br />
                            ...
                            <?php echo htmlspecialchars('在 HTML 4.01 中，<a> 标签可以是超链接或锚。在 HTML5 中，<a> 标签始终是超链接，但是如果未设置 href 属性，则只是超链接的占位符。
                            HTML5 提供了一些新属性，同时不再支持一些 HTML 4.01 属性。');?><br />
                            <?php echo htmlspecialchars('<a> 标签支持 HTML 中的全局属性。');?> <br />
                            <?php echo htmlspecialchars('<a> 标签支持 HTML 中的事件属性。');?> <br />
                        </p>
                    </div>
                </div>
            </div>
